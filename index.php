...
$xoopsOption['template_main'] = 'mycredits_index_'.$xoopsModuleConfig['mycredits_display'].'.html';
include_once(XOOPS_ROOT_PATH."/header.php");

//Affiche le nom du module et le texte d'introduction
$xoopsTpl->assign("textindex", $myts->makeTareaData4Show($xoopsModuleConfig['mycredits_text']));
...
// block delay
$xoopsTpl->assign("delay", ($xoopsModuleConfig['mycredits_delay']!=0) ? $xoopsModuleConfig['mycredits_delay']*1000 : 1000 );
